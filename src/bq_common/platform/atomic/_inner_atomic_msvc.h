...
#define SPECIALIZED_ATOMIC_BASE(SIZE_BYTE)                                                                                                                                                                                         \
    ...
    protected:                                                                                                                                                                                                                     \
        ...
        {                                                                                                                                                                                                                          \
            api_type result;                                                                                                                                                                                                       \
            BQ_ATOMIC_CHOOSE_INTRINSIC(order, result, _INTRIN_BIT_SUFFIX(_InterlockedExchangeAdd, SIZE_BYTE), get_atomic_ptr(&value_), get_atomic_value<value_type>(static_cast<value_type>(0)));                                               \
        ...
        {                                                                                                                                                                                                                          \
            api_type result;                                                                                                                                                                                                       \
            BQ_ATOMIC_INTRINSIC_ACQUIRE(result, _INTRIN_BIT_SUFFIX(_InterlockedExchangeAdd, SIZE_BYTE), get_atomic_ptr(&value_), get_atomic_value<value_type>(static_cast<value_type>(0)));                                                     \
            return (value_type)result;                                                                                                                                                                                             \
        }                                                                                                                                                                                                                          \
        bq_forceinline value_type load_relaxed() const noexcept                                                                                                                                                                    \
        {                                                                                                                                                                                                                          \
            api_type result;                                                                                                                                                                                                       \
            BQ_ATOMIC_INTRINSIC_RELAXED(result, _INTRIN_BIT_SUFFIX(_InterlockedExchangeAdd, SIZE_BYTE), get_atomic_ptr(&value_), get_atomic_value<value_type>(static_cast<value_type>(0)));                                                     \
            return (value_type)result;                                                                                                                                                                                             \
        }                                                                                                                                                                                                                          \
        bq_forceinline value_type load_acq_rel() const noexcept                                                                                                                                                                    \
        {                                                                                                                                                                                                                          \
            api_type result;                                                                                                                                                                                                       \
            BQ_ATOMIC_INTRINSIC_ACQ_REL(result, _INTRIN_BIT_SUFFIX(_InterlockedExchangeAdd, SIZE_BYTE), get_atomic_ptr(&value_), get_atomic_value<value_type>(static_cast<value_type>(0)));                                                     \
            return (value_type)result;                                                                                                                                                                                             \
        }                                                                                                                                                                                                                          \
        bq_forceinline value_type load_seq_cst() const noexcept                                                                                                                                                                    \
        {                                                                                                                                                                                                                          \
            api_type result;                                                                                                                                                                                                       \
            BQ_ATOMIC_INTRINSIC_SEQ_CST(result, _INTRIN_BIT_SUFFIX(_InterlockedExchangeAdd, SIZE_BYTE), get_atomic_ptr(&value_), get_atomic_value<value_type>(static_cast<value_type>(0)));                                                     \
            return (value_type)result;                                                                                                                                                                                             \
        }                                                                                                                                                                                                                          \
