...
#pragma warning(pop)
    ...
    struct java_buffer_info {
        jobject direct_buffer_obj;
        uint32_t offset; // offset from base of direct_buffer_obj to data
    };
#endif
    
    enum class log_buffer_type {
        normal,
        high_performance
    };
    ...
    struct log_buffer_config {
        /// <summary>Defines the type of the log buffer.</summary>
        ...
        /// <summary>Indicates whether the buffer should automatically expand when the initial size
        /// is insufficient. Relevant only for high_performance type.</summary>
        bool auto_expand;
