...
#if defined(BQ_NAPI)
        bq::miso_ring_buffer *console_msg_buffer_ = new bq::miso_ring_buffer( bq::log_buffer_config{ "napi_console_cb_msg", bq::array<bq::string>{}, 1024 * 8, false, bq::log_memory_policy::block_when_full, 0 } );
