...
namespace bq.impl
{
    public class log_invoker
    {
        ...
        [DllImport(LIB_NAME, CharSet = CharSet.Unicode)]
        public static unsafe extern _log_api_ring_buffer_write_handle __api_log_buffer_alloc(ulong log_id, uint length);

        [DllImport(LIB_NAME, CharSet = CharSet.Unicode)]
        public static unsafe extern void __api_log_buffer_commit(ulong log_id, _log_api_ring_buffer_write_handle write_handle_ptr);
