...
namespace bq.impl
{
    public class log_invoker
    {
        ...
        [DllImport(LIB_NAME, CallingConvention = CallingConvention.Cdecl,CharSet = CharSet.Unicode)]
        public static unsafe extern void __api_set_appender_enable(ulong log_id, byte* appender_name, [MarshalAs(UnmanagedType.I1)] bool enable);
        ...
        [DllImport(LIB_NAME, CallingConvention = CallingConvention.Cdecl,CharSet = CharSet.Unicode)]
        public static unsafe extern void __api_set_console_buffer_enable([MarshalAs(UnmanagedType.I1)] bool enable);
        ...
        [DllImport(LIB_NAME, CallingConvention = CallingConvention.Cdecl,CharSet = CharSet.Unicode)]
        public unsafe static extern void __api_take_snapshot_string(ulong log_id, byte* time_zone_config_str_utf8, bq.def._api_string_def* out_snapshot_string);
