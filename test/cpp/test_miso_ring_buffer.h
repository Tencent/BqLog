    ...
    namespace test {
        ...
        private:
            ...
            void do_traverse_test(test_result& result)
            {
                ...
                test_output_dynamic(bq::log_level::info, "[miso ring buffer] traverse test begin\n");
                ...
                test_output_dynamic(bq::log_level::info, "[miso ring buffer] traverse test finished\n");
            }
