...
public class test_log_1 extends test_base{
	...
	public test_result test() {
        ...
        log_inst_sync.info("这些是结果，{}, {}, {}, {}, {}, {}, {}, {}, {}, {}， 结果完成了", "abc", "abcde", -32, false, true, null, (byte)3, 3823823, (short)-32354, "测试字符串完整的");
        ...
        while(format_prefix.length() <= 1024 * 1024 + 1024 + 4) {
        	log_inst_sync.info(format_prefix + "这些是结果，{}, {}, {}, {}, {}, {}, {}, {}, {}, {}， 结果完成了", "abc", "abcde", -32, false, true, null, (byte)3, 3823823, (short)-32354, "测试字符串完整的");
