...
#if defined(BQ_POSIX)
#include "native_src_bq_common_platform_posix_misc.h"
#endif
#if defined(BQ_NAPI)
#include "native_src_bq_common_platform_napi_misc.h"
#endif
#if defined(BQ_JAVA)
#include "native_src_bq_common_platform_java_misc.h"
#endif
#if defined(BQ_WIN)
#include "native_src_bq_common_platform_win64_misc.h"
#endif
#if defined(BQ_ANDROID)
#include "native_src_bq_common_platform_android_misc.h"
#endif
#if defined(BQ_LINUX)
#include "native_src_bq_common_platform_linux_misc.h"
#endif
#if defined(BQ_UNIX)
#include "native_src_bq_common_platform_unix_misc.h"
#endif
#if defined(BQ_MAC)
#include "native_src_bq_common_platform_mac_misc.h"
#endif
#if defined(BQ_IOS)
#include "native_src_bq_common_platform_ios_misc.h"
#endif
#if defined(BQ_PS)
#include "native_src_bq_common_platform_ps_misc.h"
#endif
#if defined(BQ_OHOS)
#include "native_src_bq_common_platform_ohos_misc.h"
#endif
